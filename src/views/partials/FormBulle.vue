    ...
    <div>
        <form>
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="input-group input-group-outline my-1">
                        <select @change="changeParentId" class="form-control" name="parent_id" id="" v-model="parentId">
                            ...
                            <template v-for="(element, key) in dataStore.dataBulle" :key="key">
                ...
                <div class="col-md-6">
                    <label for="">Libellé <sup class="text-danger">*</sup></label>
                    <div class="input-group input-group-outline my-1" :class="{ 'is-invalid': props.isInvalid }">
                        <input @keyup="changeValue" v-model="libelle" placeholder="Entrer le libellé" type="texte"
                            class="form-control" :class="{ 'border-danger': props.isInvalid }">
                    </div>
                    <span v-if="props.isInvalid" class="text-danger fw-bold">Entrer le libelle de la donnée</span>
                </div>
            </div>
            <div class="form-check">
                <input @change="changeIsParentId" class="form-check-input" type="checkbox" value="" id="fcustomCheck1"
                    checked="" v-model="isParent">
